			...
			<div class="col-sm-9">
				...
				<div class="row">
					...
					<div class="paginacao col-sm-8">
						<button id="primeira" disabled class="btn btn-light">&lsaquo; Primeira</button>
						<button id="anterior" disabled class="btn btn-light">&lsaquo; </button>
						    <span id="numeracao"></span>
						<button id="proximo" disabled class="btn btn-light"> &rsaquo;</button>
						<button id="ultima" disabled class="btn btn-light">Última &rsaquo;</button>
					</div>
				</div>
